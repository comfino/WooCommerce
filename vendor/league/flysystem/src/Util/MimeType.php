...
class MimeType
{
    ...
    {
        return isset(static::$extensionToMimeTypeMap[$extension]) ? static::$extensionToMimeTypeMap[$extension] : 'text/plain';
    }
    /**
