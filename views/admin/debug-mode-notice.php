...
<div class="notice notice-warning is-dismissible" id="comfino-debug-mode-notice">
    <p>
        <strong><?= esc_html__('Comfino Debug Mode Active', 'comfino-payment-gateway') ?>:</strong>
        <?= esc_html__('Detailed logging is enabled. This may impact performance and should not be used in production environments.', 'comfino-payment-gateway') ?>
        <?php
        echo wp_kses(
            sprintf(
