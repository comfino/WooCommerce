 ...
 *
 * Rendered by Main::renderPaywallIframe() as the container for the paywall.
 * The web frontend SDK (comfino-checkout.js / comfino-blocks.js) locates
 * #comfino-paywall-container and renders the paywall iframe inside it.
