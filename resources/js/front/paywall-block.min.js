...
(Comfino.init(a),Comfino.isSelected&&ComfinoPaywallFrontend.executeClickLogic())):document.addEventListener("readystatechange",()=>{ComfinoPaywallFrontend.logEvent(`document.readyState: ${document.readyState}`,"debug");"complete"===document.readyState&&(Comfino.init(a),Comfino.isSelected&&ComfinoPaywallFrontend.executeClickLogic())});return!0},ariaLabel:Comfino.label,supports:{features:comfinoSettings.supports}});
